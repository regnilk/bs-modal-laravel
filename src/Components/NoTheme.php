<?php
    ...
    class NoTheme extends Component
    {
         ...
         * @param string $mode
         */
        public function __construct($title, $url, $message, $colorClass, $icon = NULL, $iconModal = NULL, $btnText = '', $modalBtnText='', $comment = NULL, $commentRequired = NULL, $outline = FALSE, $method='PATCH', $mode='button')
        {
            $this->id = str_random();
            $this->title = $title;
            $this->url = $url;
