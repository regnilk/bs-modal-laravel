<?php
    ...
    class NoTheme extends Component
    {
         ...
         */
        public function __construct($title, $url, $message, $colorClass, $icon = NULL, $iconModal = NULL, $btnText = '', $modalBtnText='', $comment = FALSE, $outline = FALSE, $method='PATCH', $mode='button')
        {
            $this->id = str_random();
            $this->title = $title;
            $this->url = $url;
